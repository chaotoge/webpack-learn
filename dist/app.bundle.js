...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__cats__ = __webpack_require__(114);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__cats___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__cats__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_jquery__ = __webpack_require__(116);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_jquery__);
 
 
 

 __WEBPACK_IMPORTED_MODULE_2_jquery___default()('<h1>Cats</h1>').appendTo('body');
 const ul = __WEBPACK_IMPORTED_MODULE_2_jquery___default()('<ul></ul>').appendTo('body');
 for (const cat of __WEBPACK_IMPORTED_MODULE_1__cats___default.a) {
     __WEBPACK_IMPORTED_MODULE_2_jquery___default()('<li></li>').text(cat).appendTo(ul);
 }
